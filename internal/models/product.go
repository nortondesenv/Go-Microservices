...
func (p *Product) ToProto() *productsServicePB.Product {
	return &productsServicePB.Product{
...
func (p *ProductsList) ToProtoList() []*productsServicePB.Product {
	productsList := make([]*productsServicePB.Product, 0, len(p.Products))
